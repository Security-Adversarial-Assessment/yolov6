...
def build_network(config, channels, num_classes, num_layers, fuse_ab=False, distill_ns=False):
    ...
    if distill_ns:
        from  detectors.intelligentAlgorithm.yolov6.yolov6.models.heads.effidehead_distill_ns import Detect, build_effidehead_layer
        if num_layers != 3:
        ...
        from  detectors.intelligentAlgorithm.yolov6.yolov6.models.heads.effidehead_fuseab import Detect, build_effidehead_layer
        ...
        from  detectors.intelligentAlgorithm.yolov6.yolov6.models.effidehead import Detect, build_effidehead_layer
