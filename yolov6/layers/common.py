...
from detectors.intelligentAlgorithm.yolov6.yolov6.utils.general import download_ckpt
...
class DetectBackend(nn.Module):
    def __init__(self, weights='yolov6s.pt', device=None, dnn=True):
        ...
        from detectors.intelligentAlgorithm.yolov6.yolov6.utils.checkpoint import load_checkpoint
